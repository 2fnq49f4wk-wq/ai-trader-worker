...
// positions 테이블 자체가 없을 수도 있으니 생성
try {
...
// ============================================================
// 매수: savePosition이 실패하면 cash 롤백 (오류 시 현금 안 사라짐)
// ============================================================
...
return cash; // cash 그대로 반환 (차감 안 함)
}

// savePosition 성공한 뒤에만 cash 차감 + 거래 기록
cash[market] -= total;
...
// ★ RESET: cash도 명시적으로 초기 1천만원으로 재설정
