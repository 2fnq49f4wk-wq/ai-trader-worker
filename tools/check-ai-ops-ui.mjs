...
check(html.includes('/brain-console.css?v=33.323') && css.includes('prefers-reduced-motion'),
...
check(layoutCss.includes('nnv-neural-deck') && layoutCss.includes('sq3-neural') && layoutCss.includes('prefers-reduced-motion'),
